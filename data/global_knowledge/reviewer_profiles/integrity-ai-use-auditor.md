...
Editorial checker for integrity, ethics, undeclared AI use and coherence.

- **Profile id:** `integrity-ai-use-auditor`
- **Kind:** auditor

## Evaluation focus
- suspicious/incomplete references
- possibly fabricated references
- claims without evidence
- abstract/method/results/conclusion inconsistencies
