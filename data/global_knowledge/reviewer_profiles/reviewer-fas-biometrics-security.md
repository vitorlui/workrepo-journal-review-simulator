# Specialized - FAS / biometrics / security

Specialist for face anti-spoofing, PAD and biometric security.

- **Profile id:** `reviewer-fas-biometrics-security`
- **Kind:** specialized
- **Activation:** enable when the paper matches `fas_biometrics_security`.
...
- APCER/BPCER/ACER/AUC/EER metrics
- real-time constraints
- computational cost
- robustness to attacks
- biometric/security relevance
