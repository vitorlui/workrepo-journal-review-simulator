# Specialized - Dataset / benchmark / data descriptor

Specialist for dataset, benchmark, corpus and data-descriptor papers.

- **Profile id:** `reviewer-dataset-benchmark`
- **Kind:** specialized
- **Activation:** enable when the paper matches `dataset_benchmark`.
...
- fit for Scientific Data / Data in Brief / JOSS / GigaScience / Patterns
